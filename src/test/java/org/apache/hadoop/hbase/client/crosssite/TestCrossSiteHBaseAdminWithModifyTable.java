...
public class TestCrossSiteHBaseAdminWithModifyTable {
  ...
  @Test
  public void testPutAndScanAfterModifyTableWithScope() throws Exception {
    ...
    String tableName = "testPutAndScanAfterModifyTableWithScope";
